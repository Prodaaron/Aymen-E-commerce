  ...
  return (
    <div className='contact-page'>
      ...
      <div className="social-media-container">
        <a href="#"><img className="social-media-icon social-media-icon-contact" src={Instagram} alt="Instagram" /></a>
        <a href="#"><img className="social-media-icon social-media-icon-contact" src={Telegram} alt="Telegram" /></a>
        <a href="#"><img className="social-media-icon social-media-icon-contact" src={Tiktok} alt="TikTok" /></a>
